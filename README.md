...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/point_data \
  -H 'Content-Type: application/json' \
  -d '{"latitude":40.7128,"longitude":-74.006,"start":"20230101","end":"20231231"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/point_data`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
